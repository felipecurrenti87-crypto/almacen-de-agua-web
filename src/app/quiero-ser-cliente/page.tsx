      ...
      <WaveCTA>
        <AnimatedSection>
          <h2 className="font-heading font-bold text-2xl sm:text-3xl text-white mb-3">
            Preferis hablar con nosotros?
          </h2>
          <p className="text-[#BBD6E1] text-sm sm:text-base mb-8 max-w-md mx-auto">
            Escribinos por WhatsApp y te ayudamos a sumarte en el momento.
          </p>
          <a
            href={`${business.whatsappLink}?text=${encodeURIComponent("Hola! Quiero ser cliente de Almacen de Agua")}`}
            target="_blank"
            rel="noopener noreferrer"
