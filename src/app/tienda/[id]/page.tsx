...
function DispenserDetail({ product }: { product: Product }) {
  ...
  return (
    <div>
      ...
      <section className="relative bg-negro pt-28 pb-32 md:pt-36 md:pb-40 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <AnimatedSection>
              <div
                ...
                className="relative aspect-square rounded-3xl bg-gradient-to-br from-negro-light to-negro-medium p-10 border border-celeste-neon/10 overflow-hidden"
              >
                {/* Water drops */}
            ...
            <div>
              ...
              <AnimatedSection delay={100}>
                <p className="text-gris-dark text-lg leading-relaxed mb-6">
                  {product.descripcion}
                </p>
              </AnimatedSection>
              ...
              <AnimatedSection delay={200}>
                <div className="flex items-end gap-4 mb-8">
                  <span className="price text-4xl font-bold text-celeste-neon">
                    {formatPrice(price)}
                  </span>
                </div>
              </AnimatedSection>
              ...
              <AnimatedSection delay={300}>
                <div className="flex flex-col sm:flex-row gap-3 mb-8">
                  <button
                    onClick={handleAdd}
                    className={`flex-1 flex items-center justify-center gap-2 py-4 px-6 rounded-2xl font-heading font-bold text-lg transition-all duration-300 ${
                      added
                  ...
                  <a
                    ...
                    className="flex-1 liquid-glass-btn-outline flex items-center justify-center gap-2 py-4 px-6 rounded-2xl font-heading font-bold text-lg text-white hover:-translate-y-0.5 transition-all"
                  >
      ...
      <section id="specs-section" className="py-16 md:py-24 bg-negro relative overflow-hidden">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function SpecRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex items-center justify-between py-3 px-5 rounded-xl bg-negro-medium/80 border border-celeste-neon/8 hover:border-celeste-neon/20 transition-colors">
      <span className="text-gris-dark text-sm font-heading">{label}</span>
      <span className="text-white font-heading font-semibold text-sm text-right max-w-[60%]">
        {value}
      </span>
    </div>
  );
