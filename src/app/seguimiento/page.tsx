    ...
    <div className="relative min-h-screen bg-negro overflow-hidden">
      ...
      <div className="relative pt-28 sm:pt-36 pb-16 sm:pb-20 max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <AnimatedSection delay={200}>
          <div className="bg-negro-light/80 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-celeste-neon/10 mb-8 text-center">
            ...
            <p className="text-gris-dark text-sm mb-6 max-w-md mx-auto">
              Nuestro equipo te responde en minutos durante el horario de atencion: {business.horarios.semana}.
            </p>
            <button
              onClick={handleWhatsApp}
              className="liquid-glass-btn inline-flex items-center gap-2 px-8 py-4 rounded-2xl font-heading font-bold text-lg text-white hover:-translate-y-0.5 transition-transform"
            >
        ...
        <AnimatedSection delay={300}>
          <h3 className="font-heading font-bold text-lg text-celeste-glow mb-6 text-center">
            Como funciona
          </h3>
        </AnimatedSection>
        ...
        <StaggerContainer className="space-y-4" delay={400}>
          {steps.map((step, i) => (
            <StaggerItem key={i}>
              <div className="flex items-start gap-4 bg-negro-light/60 backdrop-blur-sm rounded-2xl p-5 border border-celeste-neon/10 hover:border-celeste-neon/25 transition-colors">
                ...
                <div>
                  ...
                  <h4 className="font-heading font-bold text-white text-sm mb-0.5">
                    {step.title}
                  </h4>
                  <p className="text-gris-dark text-xs">{step.desc}</p>
                </div>
              </div>
            </StaggerItem>
          ))}
          ...
          <div className="mt-8 bg-celeste-neon/5 rounded-2xl p-5 border border-celeste-neon/10">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-gris-dark">
                <p className="mb-1">
                  <strong className="text-white">Horario de atencion:</strong> {business.horarios.semana} | {business.horarios.sabado}
                </p>
                <p>
