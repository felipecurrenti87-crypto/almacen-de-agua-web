    ...
    <>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 w-full z-[2]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-32 md:py-40">
            {/* Left: Text content */}
            <motion.div
              style={{ y: heroTextY, opacity: heroTextOpacity }}
            >
              <TextRevealLine delay={0}>
                <span className="inline-flex items-center gap-2 bg-celeste-neon/10 backdrop-blur-sm text-celeste-glow text-sm font-heading font-semibold px-4 py-2 rounded-full mb-6 border border-celeste-neon/20">
              ...
              <TextRevealLine delay={300}>
                <p className="text-gris-dark text-lg sm:text-xl leading-relaxed mb-8 max-w-lg">
              ...
              <AnimatedSection delay={450}>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link
                    href="/tienda"
                    className="liquid-glass-btn inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl font-heading font-bold text-lg text-white hover:-translate-y-0.5 active:translate-y-0"
                  >
                    Pedi ahora
                  ...
                  <a
                    ...
                    className="liquid-glass-btn-outline inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl font-heading font-bold text-lg text-white hover:-translate-y-0.5"
                  >
              ...
              <AnimatedSection delay={600}>
                <div className="flex items-center gap-6 mt-10">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-gris-dark text-sm ml-1">
                      {business.rating}/5
                    </span>
                  </div>
          ...
          <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {whyUs.map((item) => (
              <StaggerItem key={item.title}>
                <div className="group bg-celeste-light/40 hover:bg-white rounded-3xl p-7 transition-all duration-500 hover:shadow-xl hover:shadow-celeste/10 border border-transparent hover:border-celeste-medium/30 h-full">
                  <div className="w-14 h-14 rounded-2xl bg-celeste/10 text-celeste flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-celeste group-hover:text-white group-hover:scale-110 group-hover:rotate-3">
                    {item.icon}
                  </div>
                  <h3 className="font-heading font-bold text-azul text-lg mb-2">
                    {item.title}
                  </h3>
      ...
      <section className="relative py-20 md:py-28 bg-celeste-light/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <AnimatedSection>
              <span className="font-heading font-semibold text-celeste-neon text-sm uppercase tracking-wider">
