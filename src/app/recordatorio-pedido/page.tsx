  ...
  return (
    <div className="relative min-h-screen bg-negro overflow-hidden">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] rounded-full bg-celeste-neon/8 blur-[120px] animate-orb-pulse" />
        <div className="absolute bottom-[-15%] left-[-10%] w-[600px] h-[600px] rounded-full bg-celeste-glow/6 blur-[140px] animate-orb-pulse" style={{ animationDelay: "3s" }} />
      </div>
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <svg className="absolute inset-0 w-full h-full opacity-[0.06] animate-wave-drift" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
          <defs>
            <pattern id="waves-reminder" x="0" y="0" width="200" height="80" patternUnits="userSpaceOnUse">
          ...
          <rect width="100%" height="100%" fill="url(#waves-reminder)" />
        </svg>
      </div>
