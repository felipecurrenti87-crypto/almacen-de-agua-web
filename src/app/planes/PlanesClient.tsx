      ...
      <div className={`relative rounded-[1.5rem] p-[1px] overflow-hidden ${
        ...
        <div className={`absolute inset-0 rounded-[1.5rem] transition-all duration-500 ${
          plan.destacado
            ...
            : "bg-gradient-to-br from-[#BBD6E1]/70 via-[#BBD6E1]/30 to-[#BBD6E1]/60 group-hover:from-celeste-neon/40 group-hover:to-celeste-glow/30"
        }`} />

        <div className="relative rounded-[1.5rem] bg-white shadow-[0_14px_44px_-14px_rgba(28,48,85,0.2)] p-6 sm:p-8 h-full flex flex-col">
            ...
            <div className="relative mb-4">
              <span className={`inline-block text-xs font-heading font-bold uppercase tracking-wider px-3 py-1 rounded-full ${
                plan.destacado
                  ...
                  : "bg-[#EEF5F8] text-[#639BB6] border border-[#BBD6E1]/70"
              }`}>
                {plan.tag}
              </span>
            </div>
          ...
          <h3 className="relative font-heading font-bold text-azul text-lg sm:text-xl mb-2">
            {plan.nombre}
          </h3>

          <div className="relative mb-4">
            <span className={`text-4xl sm:text-5xl font-bold font-heading tracking-tight ${
              plan.destacado ? "gradient-text-glow" : "text-azul"
            }`}>
              {formatPrice(plan.precio)}
            </span>
            <span className="text-[#52647A] text-sm ml-1">/mes</span>
            {plan.precioTienda && (
              <p className="text-xs text-[#639BB6]/70 mt-1 font-heading">
                En tienda: {formatPrice(plan.precioTienda)}/mes
              </p>
            )}
          </div>

          <p className="relative text-[#52647A] text-sm leading-relaxed mb-6">
            {plan.descripcion}
          </p>
          ...
          <ul className="relative space-y-3 mb-8 flex-1">
            {plan.detalles.map((d, i) => (
              <li key={i} className="flex items-start gap-3 text-sm">
                ...
                <span className="text-[#52647A]/90">{d}</span>
              </li>
            ))}
          </ul>
          ...
          <a
            ...
            className={`relative w-full flex items-center justify-center gap-2 py-3.5 rounded-xl font-heading font-bold text-sm transition-all duration-300 ${
              plan.destacado
                ? "bg-[#1C3055] text-[#ffffff] hover:bg-[#16264a]"
                : "border border-[#1C3055]/25 text-azul hover:border-celeste-neon/60 hover:bg-celeste-neon/5"
            }`}
          >
  ...
  return (
    <div className="min-h-screen bg-[#EEF5F8] text-azul relative">
      ...
      <section className="relative pt-28 sm:pt-36 pb-12 sm:pb-20 overflow-hidden">
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 text-center">
          ...
          <TextRevealWords
            as="h1"
            center
            className="font-heading font-bold uppercase gradient-text-glow text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-4 sm:mb-6"
          >
            Elegi el plan ideal para vos
          </TextRevealWords>
          <AnimatedSection delay={100}>
            <p className="text-[#52647A] text-base sm:text-lg max-w-2xl mx-auto">
          ...
          <AnimatedSection delay={200}>
            <div className="flex justify-center mb-10 sm:mb-14">
              <div className="relative flex items-center gap-1 rounded-2xl p-1.5 overflow-hidden">
                <div className="absolute inset-0 bg-[#EEF5F8]/95 backdrop-blur-xl border border-[#BBD6E1]/60 rounded-2xl" />
                {(["hogar", "comercio"] as PlanMode[]).map((m) => (
                  <button
                    ...
                    style={{ color: mode === m ? "#FFFFFF" : "#1C3055" }}
                  >
                    {mode === m && (
                      <motion.div
      ...
      <section className="relative pb-16 sm:pb-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <AnimatePresence mode="wait">
            ...
            >
              {planes.map((plan, i) => (
                <PlanCard key={plan.id} plan={plan} index={i} mode={mode} />
              ))}
            </motion.div>
          </AnimatePresence>
        </div>
      ...
      <section className="relative pb-16 sm:pb-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <AnimatedSection>
            <h3 className="font-heading font-bold text-xl sm:text-2xl text-azul text-center mb-3">
              Todos los planes incluyen
            </h3>
            <p className="text-[#52647A] text-sm text-center mb-10 max-w-lg mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            {beneficiosComunes.map((b, i) => (
              ...
              >
                ...
                <div className="relative rounded-2xl bg-white shadow-[0_14px_44px_-14px_rgba(28,48,85,0.2)] p-4 sm:p-6 text-center h-full">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-xs sm:text-sm text-[#52647A] font-heading font-semibold leading-snug">
                      {b.text}
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <AnimatedSection>
            <div className="relative rounded-[2rem] p-[1px] overflow-hidden">
              ...
              <div className="relative rounded-[2rem] bg-white shadow-[0_14px_44px_-14px_rgba(28,48,85,0.2)] p-8 sm:p-12 text-center">
                ...
                <h3 className="relative font-heading font-bold text-2xl sm:text-3xl text-azul mb-3">
                  No sabes que plan elegir?
                </h3>
                <p className="relative text-[#52647A] text-sm sm:text-base mb-8 max-w-md mx-auto">
                ...
                <div className="relative flex flex-col sm:flex-row gap-3 justify-center">
                  <Link
                    ...
                    className="bg-[#1C3055] hover:bg-[#16264a] transition-colors flex items-center justify-center gap-2 px-8 py-4 rounded-2xl font-heading font-bold text-[#ffffff] text-base"
                  >
                    Quiero ser cliente
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="border-2 border-[#1C3055]/25 hover:bg-[#EEF5F8] transition-colors flex items-center justify-center gap-2 px-8 py-4 rounded-2xl font-heading font-bold text-azul text-base"
                  >
