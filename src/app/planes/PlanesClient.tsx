        ...
        <AnimatedSection>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              ...
              className="bg-white text-[#1C3055] hover:bg-[#BBD6E1] transition-colors flex items-center justify-center gap-2 px-8 py-4 rounded-2xl font-heading font-bold text-base"
            >
              Quiero ser cliente
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="border-2 border-white/35 hover:bg-white/10 transition-colors flex items-center justify-center gap-2 px-8 py-4 rounded-2xl font-heading font-bold text-white text-base"
            >
